...
public class Print {
    ...
    public static final String MENU_ROOT1 = "[ 관리자님 ㅎㅇ ]\n";
    ...
    public static final String INPUTERROR = "\n♦♦♦♦♦♦♦♦♦♦ 입력이 잘못되었습니다 ♦♦♦♦♦♦♦♦♦♦\n";
    ...
    public static final String BORROWBOOK = "\n♦♦♦♦♦♦♦♦♦♦ 도서대여 ♦♦♦♦♦♦♦♦♦♦\n";
    public static final String ISBORROW = "\n♦♦♦♦♦♦♦♦♦♦ 선택하신 도서는 이미 대여중입니다 ♦♦♦♦♦♦♦♦♦♦\n";
    public static final String RETURNBOOK = "\n♦♦♦♦♦♦♦♦♦♦ 도서반납 ♦♦♦♦♦♦♦♦♦♦\n";
    public static final String SHOWALLOFBOOK = "\n♦♦♦♦♦♦♦♦♦♦ 도서목록 조회 ♦♦♦♦♦♦♦♦♦♦\n";
    public static final String PRINTEXCEL = "\n♦♦♦♦♦♦♦♦♦♦ 엑셀파일로 저장 ♦♦♦♦♦♦♦♦♦♦\n";
}
